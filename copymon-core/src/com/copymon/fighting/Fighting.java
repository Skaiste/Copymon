...
public class Fighting {
	...
	public Skill chooseBotSkill(){
		...
		for (int i = 1; i < firstCreature.getActiveSkillN(); i++){
			totalPower=firstCreature.getActiveSkillByIndex(i).getPower()*spellEfectivenessByType(firstCreature.getActiveSkillByIndex(i).getType(), secondCreature.getType());
		}
